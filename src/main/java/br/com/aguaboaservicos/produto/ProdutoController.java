...
public class ProdutoController {
    ...
    @GetMapping
    public ResponseEntity<Page<ProdutoInformacoes>> listaProdutos(@PageableDefault(size = 25, sort = {"nome"}) Pageable paginacao, ProdutoFiltros filtros) {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<ProdutoInformacoes> cadastraProduto(@RequestBody ProdutoCadastro dadosCadastro, UriComponentsBuilder uriBuilder) {
